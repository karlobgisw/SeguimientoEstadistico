...
<head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="{{ secure_asset('css/style7.css') }}">
...
<body>
    ...
    <div class="search">
        <form action="{{route('ver-stat')}}" method="post" class="buscador" id="#miFormulario">
            @csrf
    ...
    <script src="{{ secure_asset('js/app5.js') }}"></script>
</body>
</html>